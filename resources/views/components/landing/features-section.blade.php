    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-10">
            <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10 lg:grid-cols-3">
                <div class="relative">
                    <dt>
                        <div class="absolute flex items-center justify-center h-12 w-12 rounded-md bg-gradient-to-r from-blue-500 to-purple-600 text-white">
                            <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1m4 0h1m-6 4h.01M19 10a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                        </div>
                        <p class="ml-16 text-lg leading-6 font-medium text-gray-900 dark:text-white">Video Creation Tools</p>
                    </dt>
                ...
                <div class="relative">
                    <dt>
                        ...
                        <p class="ml-16 text-lg leading-6 font-medium text-gray-900 dark:text-white">Student Management</p>
                    </dt>
                    <dd class="mt-2 ml-16 text-base text-gray-500 dark:text-gray-300">
                ...
                <div class="relative">
                    <dt>
                        ...
                        <p class="ml-16 text-lg leading-6 font-medium text-gray-900 dark:text-white">Analytics & Insights</p>
                    </dt>
                    <dd class="mt-2 ml-16 text-base text-gray-500 dark:text-gray-300">
                ...
                <div class="relative">
                    <dt>
                        ...
                        <p class="ml-16 text-lg leading-6 font-medium text-gray-900 dark:text-white">Custom Domain</p>
                    </dt>
                    <dd class="mt-2 ml-16 text-base text-gray-500 dark:text-gray-300">
                ...
                <div class="relative">
                    <dt>
                        ...
                        <p class="ml-16 text-lg leading-6 font-medium text-gray-900 dark:text-white">Easy Publishing</p>
                    </dt>
                    <dd class="mt-2 ml-16 text-base text-gray-500 dark:text-gray-300">
